                ...
                <div class="sq-form-group sq-col-half">
                    <div class="sq-toggle-wrap">
                        <label class="sq-toggle-label" for="sender_default">
                            ...
                            <input type="checkbox" id="SQ_SENDER_IS_DEFAULT" name=" SQ_SENDER_IS_DEFAULT" value="1" {if $sender.is_default}checked{/if}>
                ...
                <div class="sq-form-group sq-col-half">
                    <div class="sq-toggle-wrap">
                        <label class="sq-toggle-label" for="sender_active">
                            ...
                            <input type="checkbox" id="SQ_SENDER_IS_ACTIVE" name="SQ_SENDER_IS_ACTIVE" value="1" {if $sender.is_active|default:1}checked{/if}>
                            <span class="sq-toggle-text">
